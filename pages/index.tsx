  ...
  return (
    <div className=" w-full h-auto">
      ...
      <section className="bg-white flex flex-col ml-[5%]  w-[90%] h-auto lg:h-screen">
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 lg:w-[88.88%] md:w-full m-auto gap-[4%] h-[1200px] sm:h-[800px]  lg:h-[48%]">
      ...
      <section className="w-full md:h-screen sm:h-[800px] h-[1200px] relative">
        ...
        >
          <div className="sm:w-[500px] w-full h-[117.5px] mt-[100px] text-white flex flex-col items-center">
            <h1 className="sm:text-[60px] text-2xl font-bold">
              Why choose Us?
            </h1>
          ...
          <div className="lg:w-[70%] w-[90%] left-[5%] h-[50%] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-[10%] absolute top-[22%] md:top-[40%] lg:left-[17%]">
